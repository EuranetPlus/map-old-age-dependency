export const config = {
	mapTitle: 'old-age-dependency', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-old-age-dependency.vercel.app/', // The url provided when deploying the map on Vercel
	...
	colourScheme: 'green-blue', // one of the following: "blue", "purple-blue", "green-blue", "orange-red", "yellow-green"
